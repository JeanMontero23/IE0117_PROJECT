...
# Se habilitan todas las alertas, advertencias, se especifica que se quiere usar C11 y se enlaza la biblioteca ncurses
...
# Las reglas establecidas para game.o incluye primero una definición del propio archivo objeto que depende de game.c y game.h
# Luego se compila game.c en game.o
# clean no tiene dependencias por lo que se ejecuta al utilizar make clean
